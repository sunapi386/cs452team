...
#define PRIORITY_TRAIN_IN_SERVER       PRIORITY_NOTIFIER
#define PRIORITY_TRAIN_OUT_SERVER      PRIORITY_NOTIFIER
#define PRIORITY_MONITOR_IN_SERVER     PRIORITY_NOTIFIER
#define PRIORITY_MONITOR_OUT_SERVER    PRIORITY_NOTIFIER

#define PRIORITY_CLOCK_NOTIFIER        PRIORITY_NOTIFIER
#define PRIORITY_CLOCK_SERVER          PRIORITY_NOTIFIER
