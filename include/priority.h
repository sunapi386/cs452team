...
#define PRIORITY_COURIER            15
#define PRIORITY_SERVER             16
#define PRIORITY_USERTASK           24
...
#define PRIORITY_SENSOR_WORKER         PRIORITY_COURIER
#define PRIORITY_SENSOR_SERVER         PRIORITY_SERVER

#define PRIORITY_SENSOR_COURIER        PRIORITY_COURIER
#define PRIORITY_COMMAND_WORKER        PRIORITY_COURIER
#define PRIORITY_LOCATION_WORKER       PRIORITY_COURIER
#define PRIORITY_ENGINEER              PRIORITY_SERVER

#define PRIORITY_NAMESERVER            PRIORITY_SERVER
#define PRIORITY_LOG_SERVER            PRIORITY_SERVER
#define PRIORITY_TRACKSERVER           PRIORITY_SERVER

#define PRIORITY_CLOCK_DRAWER          PRIORITY_USERTASK
#define PRIORITY_PARSER                PRIORITY_USERTASK
#define PRIORITY_SENSOR_DRAWER         PRIORITY_USERTASK
#define PRIORITY_TURNOUT_TASK          PRIORITY_USERTASK
